...
class SendCompanyInvoiceReminder3Days extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'invoice:company-reminder-3-days';
     ...
     * @var string
     */
    protected $description = 'Send a reminder of open invoices 3 days before expiration to companies';
