...
<section id="convite" class="section gradient-bg contact-section">
    <div class="container">
        ...
        <div class="text-center m-t-30">
            <a href="/convite/cliente" class="btn btn-success m-r-5" title="Convite cliente">Convite para cliente</a>
            <a href="/convite/profissional" class="btn btn-success " title="Convite profissional">Convite para profissional</a>
        </div>
