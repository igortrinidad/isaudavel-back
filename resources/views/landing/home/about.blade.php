...
@section('content')
    ...
    @include('landing.home.presentation')
                    ...
                    <div class="card min-height-card wow fadeInUp m-t-30">
                        ...
                        <div class="card-body card-padding text-justify">
                            ...
                            <div class="text-center m-t-30">
                                <a href="{!! route('landing.clients.about') !!}" class="btn btn-success btn-lg">Saiba mais</a>
                            </div>
                        </div>
                    </div>
                </div>
